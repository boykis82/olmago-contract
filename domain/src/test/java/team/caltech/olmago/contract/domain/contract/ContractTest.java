  ...
  */
  ...
  public void 패키지계약유지중_구성품이겹치지않는상품으로변경하면_기존기본혜택은모두해지접수되고신규기본혜택은가입접수됨() {
    ...
    contract.changeContract(
        ...
        termProductCodes,
        List.of(
            ContractFixtures.createProductSubscription(contract, "NMP0000002", changeRcvDtm),
            ContractFixtures.createProductSubscription(contract, "NMB0000003", changeRcvDtm),
            ContractFixtures.createProductSubscription(contract, "NMB0000004", changeRcvDtm)
        ),
        changeRcvDtm
    );
 ...
 */
  ...
  public void 패키지계약유지중_구성품이일부겹치는상품으로변경하면_기존기본혜택중겹치는건해지접수되고_겹치지않는건유지되고_겹치치않는신규기본혜택은가입접수됨() {
    ...
    contract.changeContract(
        ...
        termProductCodes,
        List.of(
            ContractFixtures.createProductSubscription(contract, "NMP0000003", changeRcvDtm)
        ),
        changeRcvDtm
    );
    // then
