...
public class UzooPassAllProductFactoryTest extends ProductFactoryTestBase {
  ...
  public void 이동전화연계없이_배민과_비최초가입이면_상품가입3건_기본혜택할인2건생성된다() {
    // given
    Contract allContract = ContractFixtures.createUzoopassAllContract(subRcvDtm);
    Contract optContract = ContractFixtures.createBaeminContract(subRcvDtm, ContractType.OPTION);
