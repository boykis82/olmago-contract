...
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCP0000001',null,8900,'ONE_MONTH','우주패스All_Life_Standard_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,100);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCP0000002',null,4800,'ONE_MONTH','우주패스Mini_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,101);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCP0000003',null,2800,'ONE_MONTH','우주패스Slim_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,102);

insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCB0000001',null,100,'INFINITE','패키지 기본혜택 100%할인','IMMEDIATELY','BASIC_BENEFIT_FREE','RATE',0,103);

insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCO0000001',null,7900,'INFINITE','Flo 옵션 7900원 할인','IMMEDIATELY','OPTION','AMOUNT',0,300);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCO0000002',null,6000,'INFINITE','게임패스 옵션 6000원 할인','IMMEDIATELY','OPTION','AMOUNT',0,301);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCO0000003',null,5000,'INFINITE','배민 옵션 5000원 할인','IMMEDIATELY','OPTION','AMOUNT',0,302);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCO0000004',null,5000,'INFINITE','야놀자 옵션 5000원 할인','IMMEDIATELY','OPTION','AMOUNT',0,303);

insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000001',null,11800,'ONE_MONTH','게임패스 얼티밋 단품_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,400);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000002',null,7800,'ONE_MONTH','Flo and Data 단품_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,401);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000003',null,8900,'ONE_MONTH','Flo and Data 플러스 단품_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,402);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000004',null,7900,'INFINITE','Flo and Data 단품_이동전화요금제할인(프라임플러스,플래티넘,맥스)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',0,403);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000005',null,5530,'INFINITE','Flo and Data 단품_이동전화요금제할인(프라임,스페셜)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',0,404);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000006',null,9000,'INFINITE','Flo and Data 플러스 단품_이동전화요금제할인(플래티넘)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',0,405);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000007',null,7900,'INFINITE','Flo and Data 플러스 단품_이동전화요금제할인(프라임플러스,맥스)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',0,406);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000008',null,5530,'INFINITE','Flo and Data 플러스 단품_이동전화요금제할인(프라임,스페셜)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',0,407);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCU0000009',null,4900,'ONE_MONTH','배달의민족 단품_최초가입할인','IMMEDIATELY','THE_FIRST_SUBSCRIPTION','AMOUNT',0,408);

insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCC0000001','CP00000001',100,'ONE_MONTH','쿠폰할인1','IMMEDIATELY','COUPON','RATE',0,200);

insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCM0000001',null,9900,'INFINITE','이동전화 요금제 연계(all/life) 100%할인(프라임플러스이상)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',1,500);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCM0000002',null,5000,'INFINITE','이동전화 요금제 연계(all/life) 5000원 할인(프라임)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',1,501);
insert into dc_plcy (dc_plcy_cd, copn_plcy_cd, dc_amt_or_rate, dc_prd_typ, dc_plcy_nm, dc_sta_dt_typ, dc_typ, dc_unit, div_use_days, dc_prty) values ('DCS0000001',null,4900,'THREE_MONTHS','이동전화 요금제 연계(all/life) 4900원 추가할인(프라임)_프로모션(20220901~20221231)','IMMEDIATELY','MOBILE_PHONE_PRICE_PLAN_LINKED','AMOUNT',1,502);
